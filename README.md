...
- 연꽃은 수중 근경과 수심을 제외하고 수면에서 꽃머리까지의 높이로 편집·랜덤화·내보내기
...
- 같은 종의 높이와 꽃·꽃차례 크기를 종별 실측 범위 안에서 독립적으로 시드 랜덤화
...
- 개체별 실제 높이·꽃 지름·줄기 두께·방위·기울기·꽃자루·잎 크기/수·가지 수/각도 편집으로 랜덤값 덮어쓰기
